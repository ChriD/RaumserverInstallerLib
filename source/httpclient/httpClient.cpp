...
namespace RaumserverInstaller
{
    ...
    {
        HttpClient::HttpClient() : RaumserverInstallerBase()
        {            
        ...
        {                                 
            ...
            std::shared_ptr<RaumserverInstaller::HttpClient::HttpRequest> httpRequest = std::shared_ptr<HttpRequest>(new HttpRequest(getNextRequestId(), _requestUrl, _headerVars, _postVars, _userData, _callback));
        ...
        {
            std::vector<std::shared_ptr<RaumserverInstaller::HttpClient::HttpRequest>> finishedRequests;
