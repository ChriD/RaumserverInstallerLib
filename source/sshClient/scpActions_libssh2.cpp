...
namespace RaumserverInstaller
{
    namespace SSHClient
    {
        ...
        SCPActions_Libssh2::SCPActions_Libssh2() : SCPActions()
        {  
            stopThreads = false;
            scpSession = nullptr;
        }
        ...
        SCPActions_Libssh2::~SCPActions_Libssh2()
        {
            //cancelActions();
        }


        void SCPActions_Libssh2::setError(const std::string &_error, const std::int16_t &_errorCode)
        {
        ...
        void SCPActions_Libssh2::cancelActions()
        {
            stopThreads = true;
        ...
        bool SCPActions_Libssh2::makeDir(std::string _dir)
        {      
        ...
        bool SCPActions_Libssh2::removeDir(std::string _dir)
        {
        ...
        void SCPActions_Libssh2::copyDir(std::string _clientDir, std::string _remoteDir, bool _recursive, bool _sync)
        {
            if (!sessionsExists())
                return;
            ...
            copyDirThreadObject = std::thread(&SCPActions_Libssh2::copyDirThread, this, _clientDir, _remoteDir, _recursive);
            if (_sync)
                copyDirThreadObject.join();            
        }


        void SCPActions_Libssh2::copyDirThread(std::string _clientDir, std::string _remoteDir, bool _recursive)
        {                          
        ...
        bool SCPActions_Libssh2::removeFile(std::string _file)
        {
            std::int32_t returnCode = 0;
            std::string result;
        ...
        bool SCPActions_Libssh2::copyFile(std::string _clientFile, std::string _remoteFile)
        {
        ...
        bool SCPActions_Libssh2::previousDir()
        {
        ...
        bool SCPActions_Libssh2::setChmod(std::string _fileOrDir, std::uint16_t _chmod)
        {
            std::int32_t returnCode = 0;
            std::string result;
        ...
        bool SCPActions_Libssh2::existsFile(std::string _file)
        {
            std::string result;
        ...
        bool SCPActions_Libssh2::sessionsExists()
        {
        ...
        void SCPActions_Libssh2::setSessions(ssh_session _sshSession, ssh_scp _scpSession)
        {
            sshSession = _sshSession;
            scpSession = _scpSession;
        }

        bool SCPActions_Libssh2::connect(std::string _directory, bool _readMode, bool _leaveDir)
        {
        ...
        bool SCPActions_Libssh2::executeCommand(const std::string &_command, std::string &_result)
        {
            ssh_channel channel;
            int rc;
